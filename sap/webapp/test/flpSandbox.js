		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GSITM-ERP",
									"targetURL": "#comgsitmfiorisap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgsitmfiorisap-display": {
								"semanticObject": "comgsitmfiorisap",
								"action": "display",
								"description": "TEST01",
								"title": "GSITM-ERP",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gsitm.fiori.sap",
									"url": sap.ui.require.toUrl("com/gsitm/fiori/sap")
								}
							}
						}
					}
