		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GSITM-ERP",
									"targetURL": "#comgsitmfioritestlocalization-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgsitmfioritestlocalization-display": {
								"semanticObject": "comgsitmfioritestlocalization",
								"action": "display",
								"description": "SAP FIORI Localization TEST",
								"title": "GSITM-ERP",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gsitm.fiori.testlocalization",
									"url": sap.ui.require.toUrl("com/gsitm/fiori/testlocalization")
								}
							}
						}
					}
